...
,nPorts = 3,                    nConExt=3,
    ...
    Placement(transformation(origin = { -0.2067394137044971, -0.07465812043628262 },
    extent = {{10, -10}, {-10, 10}}
)));
    ...
    Placement(transformation(origin = { -43.36723180292784, -98.56182967022961 },
    extent = {{10, -10}, {-10, 10}}
)));
     ...
     annotation (
    Placement(transformation(origin = { 39.088308303790456, -100.0 },
    extent = {{10, -10}, {-10, 10}}
)));
equation        
        connect(space_1.heaPorRad,heatPortRad[1])
        annotation (Line(
        points={{ -0.2067394137044971, -0.07465812043628262 }    ,{ -0.10336970685224856, -0.07465812043628262 }    ,{ -0.10336970685224856, 0.0 }    ,{ 0.0, 0.0 }    },
        color={0, 0, 139},
        thickness=0.1,pattern =
        LinePattern.Dash,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ -0.2067394137044971, -0.07465812043628262 }    ,{ -21.78698560831617, -0.07465812043628262 }    ,{ -21.78698560831617, -98.56182967022961 }    ,{ -43.36723180292784, -98.56182967022961 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
            ;        
        connect(space_1.weaBus,weather_10.weaBus)
        annotation (Line(
        points={{ -0.2067394137044971, -0.07465812043628262 }    ,{ 19.44078444504298, -0.07465812043628262 }    ,{ 19.44078444504298, -100.0 }    ,{ 39.088308303790456, -100.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        connect(space_1.ports[1],ports_b[1])
            ;        
        connect(weather_10.weaBus,dataBus)
        annotation (Line(
        points={{ 39.088308303790456, -100.0 }    ,{ 39.088308303790456, -100.0 }    ,{ 39.088308303790456, -100.0 }    ,{ 39.088308303790456, -100.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        space_1_ideal_heating.Components.BaseClasses.DataServer
...
,nPorts = 3,                    nConExt=3,
    ...
    Placement(transformation(origin = { 1000.0, 531.4690252988014 },
    extent = {{10, -10}, {-10, 10}}
)));
        space_1_ideal_heating.Components.BaseClasses.OccupancyOccupancy_0
    occupancy_0(    gain=[35; 70; 30],
    ...
    extent = {{10, -10}, {-10, 10}}
        ...
        data_bus (redeclare package
          Medium = Medium) annotation (
    Placement(transformation(origin = { 737.4233468947539, 327.5603340218562 },
    extent = {{10, -10}, {-10, 10}}
)));
...
equation            
        ...
        connect(emission.y,emission_control.y)
        annotation (Line(
        points={{ 0.0, -75.0 }    ,{ 500.0, -75.0 }    ,{ 500.0, 531.4690252988014 }    ,{ 1000.0, 531.4690252988014 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 1000.0, 531.4690252988014 }    ,{ 868.7116734473769, 531.4690252988014 }    ,{ 868.7116734473769, 327.5603340218562 }    ,{ 737.4233468947539, 327.5603340218562 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ -50.0, 0.0 }    ,{ 343.71167344737694, 0.0 }    ,{ 343.71167344737694, 327.5603340218562 }    ,{ 737.4233468947539, 327.5603340218562 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 0.0, 0.0 }    ,{ 368.71167344737694, 0.0 }    ,{ 368.71167344737694, 327.5603340218562 }    ,{ 737.4233468947539, 327.5603340218562 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
