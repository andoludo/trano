package single_zone_hydronic_occupancy_from_data
...
,nPorts = 3,                    nConExt=2,
    ...
    Placement(transformation(origin = { -5.546698615621423, -4.705030269073603 },
    extent = {{ 5, -5}, {-5, 5}}
)));
...
equation        
        ...
        annotation (Line(
        points={{ -5.546698615621423, -4.705030269073603 }    ,{ -13.046698615621423, -4.705030269073603 }    ,{ -13.046698615621423, -4.705030269073603 }    ,{ -20.546698615621423, -4.705030269073603 }    },
        color={255,204,51},
        ...
        annotation (Line(
        points={{ -5.546698615621423, -4.705030269073603 }    ,{ -43.77715055716472, -4.705030269073603 }    ,{ -43.77715055716472, -78.91386637878021 }    ,{ -82.00760249870801, -78.91386637878021 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ -82.00760249870801, -78.91386637878021 }    ,{ -82.00760249870801, -78.91386637878021 }    ,{ -82.00760249870801, -78.91386637878021 }    ,{ -82.00760249870801, -78.91386637878021 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        single_zone_hydronic_occupancy_from_data.Components.BaseClasses.DataServer
...
extends single_zone_hydronic_occupancy_from_data.Trano.Occupancy.SimpleOccupancy ;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
connect(dataBus.co2_01, passthrough_2.u);
connect(dataBus.temp_01, passthrough_1.u);
...
end single_zone_hydronic_occupancy_from_data;