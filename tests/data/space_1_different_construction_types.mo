...
,
    ...
    redeclare package Medium = Medium,
    final inc={ IDEAS.Types.Tilt.Wall }) annotation (
    Placement(transformation(origin = { 115.0, 30.0 },
    extent = {{ 3, -3}, {-3, 3}}
)));
        IDEAS.Buildings.Components.Window[1]
    merged_win1_2(
    ...
    redeclare package Medium = Medium,
    final inc={ IDEAS.Types.Tilt.Wall }) annotation (
    Placement(transformation(origin = { 115.0, 40.0 },
    extent = {{ 3, -3}, {-3, 3}}
)));
...
equation        
        ...
        annotation (Line(
        points={{ 100.0, 0.0 }    ,{ 107.5, 0.0 }    ,{ 107.5, 30.0 }    ,{ 115.0, 30.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 100.0, 0.0 }    ,{ 107.5, 0.0 }    ,{ 107.5, 40.0 }    ,{ 115.0, 40.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 100.0, 0.0 }    ,{ 107.5, 0.0 }    ,{ 107.5, 50.0 }    ,{ 115.0, 50.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
