...
,nPorts = 3,                    nConExt=3,
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        Buildings.BoundaryConditions.WeatherData.ReaderTMY3
                weather_1(filNam=Modelica.Utilities.Files.loadResource
...
color={191,0,0},
thickness=0.1,
smooth=Smooth.None));    connect(space_1.weaBus,weather_1.weaBus)
annotation (Line(
...
color={191,0,0},
thickness=0.1,
smooth=Smooth.None));    connect(space_2.weaBus,weather_1.weaBus)
annotation (Line(
