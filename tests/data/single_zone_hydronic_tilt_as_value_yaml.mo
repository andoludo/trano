package single_zone_hydronic_tilt_as_value
...
package Constructions "Library of building envelope constructions"      record concreteslab_001
   ...
   extends IDEAS.Buildings.Data.Interfaces.Construction(
      mats={single_zone_hydronic_tilt_as_value.Data.Materials.brick_001
        (d=0.08),single_zone_hydronic_tilt_as_value.Data.Materials.rockwool_001
...
,
    ...
    redeclare parameter single_zone_hydronic_tilt_as_value.Data.Constructions.
    cavitywall_001
    constructionType,
    A={ 20.0, 30.0, 50.0 },
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        single_zone_hydronic_tilt_as_value.Components.BaseClasses.DataServer
...
extends single_zone_hydronic_tilt_as_value.Trano.Occupancy.SimpleOccupancy ;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
connect(dataBus.OccupiedSpace_001, occSch2.occupied);
    ...
    extends single_zone_hydronic_tilt_as_value.Trano.Controls.ventilation.PartialBoilerControl;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
connect(sum1.y, loa.Pow) annotation (Line(points={{-51,-26},{-38,-26},{-38,-76},
    ...
    extends single_zone_hydronic_tilt_as_value.Trano.Fluid.Boilers.PartialBoilerWithStorage;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
connect(dataBus.TStoBotBoiler_001, tanTemBot.T);
        ...
        model PumpPump_001
extends single_zone_hydronic_tilt_as_value.Trano.Fluid.Ventilation.PartialPump;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
end single_zone_hydronic_tilt_as_value;