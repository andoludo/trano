package three_zones_hydronic_reduced_orders_pv
...
Trano.Controls.BaseClasses.DataBus dataBus 
    annotation (
      ...
      three_zones_hydronic_reduced_orders_pv.Components.BaseClasses.PumpPump_001
     pump_001(
         dp_nominal=10000.0,
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        three_zones_hydronic_reduced_orders_pv.Components.BaseClasses.DataServerReducedOrder
...
Components.Containers.solar solar1 annotation (Placement(transformation(extent={{-24.0,32.0},{-4.0,52.0}})));
...
connect(sum1.y, loa.Pow) annotation (Line(points={{-51,-26},{-38,-26},{-38,-76},
    ...
    extends three_zones_hydronic_reduced_orders_pv.Trano.Fluid.Boilers.PartialHeatPump;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
        ...
        model PumpPump_001
extends three_zones_hydronic_reduced_orders_pv.Trano.Fluid.Ventilation.PartialPump;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
end three_zones_hydronic_reduced_orders_pv;