package house_infiltration_air_water_heat_pump_ideas
...
package Constructions "Library of building envelope constructions"      record cavity_wall_001
   ...
   extends IDEAS.Buildings.Data.Interfaces.Construction(
      mats={house_infiltration_air_water_heat_pump_ideas.Data.Materials.mineral_wool_001
        (d=0.18),house_infiltration_air_water_heat_pump_ideas.Data.Materials.brick_hollow_001
        (d=0.09),house_infiltration_air_water_heat_pump_ideas.Data.Materials.air_001
        (d=0.02),house_infiltration_air_water_heat_pump_ideas.Data.Materials.mineral_wool_001
...
,
    ...
    merged_window_0(
    redeclare parameter house_infiltration_air_water_heat_pump_ideas.Data.Glazing.
    simple_001 glazing,
    A={ 1.248 },
    final azi={ 3.14 },
    redeclare package Medium = Medium,
...
,
    ...
    merged_externalwall_1_externalwall_2(
    redeclare parameter house_infiltration_air_water_heat_pump_ideas.Data.Constructions.
    cavity_wall_001
    constructionType,
    A={ 8.66, 18.0 },
...
,
    ...
    extent = {{ 3, -3}, {-3, 3}}
        ...
        IDEAS.Buildings.Components.OuterWall[2]
    merged_externalwall_5_externalwall_6(
    redeclare parameter house_infiltration_air_water_heat_pump_ideas.Data.Constructions.
    roof_001
    constructionType,
    A={ 8.0, 8.0 },
...
,
    ...
    extent = {{ 5, -5}, {-5, 5}}
        ...
        IDEAS.Buildings.Components.OuterWall[2]
    merged_externalwall_7_externalwall_8(
    redeclare parameter house_infiltration_air_water_heat_pump_ideas.Data.Constructions.
    roof_001
    constructionType,
    A={ 9.0, 9.0 },
...
annotation (Placement(transformation(extent={{-96,76},{-76,96}})));     annotation (
    ...
    (redeclare parameter house_infiltration_air_water_heat_pump_ideas.
...
equation        
        ...
        connect(occupancy_6.dataBus,dataBus)
            ;        
        connect(bathroom_001.gainCon,heatPortCon1[1])
            ;        
        connect(bathroom_001.ports[1],ports_b[1])
            ;        
        connect(bedroom_1_001.gainCon,heatPortCon1[2])
            ;        
        connect(bedroom_1_001.ports[1],ports_b[2])
            ;        
        connect(bedroom_2_001.gainCon,heatPortCon1[3])
            ;        
        connect(bedroom_2_001.ports[1],ports_b[3])
            ;        
        connect(bedroom_3_001.gainCon,heatPortCon1[4])
            ;        
        connect(bedroom_3_001.ports[1],ports_b[4])
            ;        
        connect(kitchen_001.gainCon,heatPortCon1[5])
            ;        
        connect(kitchen_001.ports[1],ports_b[5])
            ;        
        connect(livingroom_001.gainCon,heatPortCon1[6])
            ;        
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        house_infiltration_air_water_heat_pump_ideas.Components.BaseClasses.DataServer
...
extends house_infiltration_air_water_heat_pump_ideas.Trano.Occupancy.SimpleOccupancy ;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
...
connect(sum1.y, loa.Pow) annotation (Line(points={{-51,-26},{-38,-26},{-38,-76},
    {24,-76},{24,-49},{16,-49}}, color={0,0,127}));
            ...
            model AirWaterHeatPumpBoiler_001
    extends house_infiltration_air_water_heat_pump_ideas.Trano.Fluid.Boilers.PartialAirWaterHeatPump;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
    connect(dataBus.yBoiler_001, pumpDemandSignal.u);
     end AirWaterHeatPumpBoiler_001;
     
        model PumpPump_001
extends house_infiltration_air_water_heat_pump_ideas.Trano.Fluid.Ventilation.PartialPump;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
end house_infiltration_air_water_heat_pump_ideas;