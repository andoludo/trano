package house_infiltration_boiler_ideas
...
extends Modelica.Icons.MaterialPropertiesPackage;    record timber_001 = IDEAS.Buildings.Data.Interfaces.Material (
 k=0.11,
      c=1880.0,
      rho=550.0,
      epsLw=0.88,
...
,
    ...
    merged_window_0(
    redeclare parameter house_infiltration_boiler_ideas.Data.Glazing.
    simple_001 glazing,
    A={ 1.248 },
    final azi={ 3.14 },
    redeclare package Medium = Medium,
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        house_infiltration_boiler_ideas.Components.BaseClasses.DataServer
...
extends house_infiltration_boiler_ideas.Trano.Occupancy.SimpleOccupancy ;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
...
connect(sum1.y, loa.Pow) annotation (Line(points={{-51,-26},{-38,-26},{-38,-76},
    ...
    extends house_infiltration_boiler_ideas.Trano.Fluid.Boilers.PartialBoilerWithoutStorage;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
connect(dataBus.m_flowBoiler_001, senVolFlo.V_flow);
        ...
        model PumpPump_001
extends house_infiltration_boiler_ideas.Trano.Fluid.Ventilation.PartialPump;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
end house_infiltration_boiler_ideas;