model buildings_simple_hydronic_two_zones
...
Buildings.ThermalZones.Detailed.MixedAir space_1(
    ...
    annotation (
    Placement(transformation(origin = { 91.43593168180503, 159.33064715588998 }, extent = {{-10, -10}, {10, 10}}
)));Modelica.Blocks.Sources.Constant three_way_valve_control(k= 1)
    annotation (
    Placement(transformation(origin = { -115.32319292401839, -166.31397455998055 }, extent = {{-10, -10}, {10, 10}}
...
annotation (Line(
points={{ -100.0, -125.0 }    ,{ -107.66159646200919, -125.0 }    ,{ -107.66159646200919, -166.31397455998055 }    ,{ -115.32319292401839, -166.31397455998055 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ -200.0, -225.0 }    ,{ -54.28203415909749, -225.0 }    ,{ -54.28203415909748, 159.33064715588998 }    ,{ 91.43593168180503, 159.33064715588998 }    },
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));
