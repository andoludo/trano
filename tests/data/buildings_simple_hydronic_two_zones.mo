 ...
 parameter Real scaFacRad = 1.5
  ...
  parameter Modelica.Units.SI.PressureDifference dp_nominal=dpPip_nominal +
    ...
    , extent = {{-10, -10}, {10, 10}}
        ...
        buildings_simple_hydronic_two_zones.Common.Controls.SpaceControls.PID space_control(setPoint = 295.15, yMax = 1, yMin = 0)
    annotation (
    ...
    , extent = {{-10, -10}, {10, 10}}
        ...
        buildings_simple_hydronic_two_zones.Common.Controls.SpaceControls.PID space_control_2(setPoint = 295.15, yMax = 1, yMin = 0)
    annotation (
