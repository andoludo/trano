package three_zones_hydronic_reduced_orders_iso_13790_electric
...
Trano.Controls.BaseClasses.DataBus dataBus 
    annotation (
      ...
      three_zones_hydronic_reduced_orders_iso_13790_electric.Components.BaseClasses.PumpPump_001
     pump_001(
         dp_nominal=10000.0,
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        three_zones_hydronic_reduced_orders_iso_13790_electric.Components.BaseClasses.DataServerReducedOrder
...
annotation (Line(points={{10,0},{110,0}}, color={0,0,127}));  connect(u, conVal.u_m) annotation (Line(points={{-118,0},{-22,0},{-22,-20},{0,
    ...
    extends three_zones_hydronic_reduced_orders_iso_13790_electric.Trano.Controls.ventilation.PartialBoilerControl;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
connect(sum1.y, loa.Pow) annotation (Line(points={{-51,-26},{-38,-26},{-38,-76},
    ...
    extends three_zones_hydronic_reduced_orders_iso_13790_electric.Trano.Fluid.Boilers.PartialBoilerWithStorage;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
connect(dataBus.TStoBotBoiler_001, tanTemBot.T);
        ...
        model PumpPump_001
extends three_zones_hydronic_reduced_orders_iso_13790_electric.Trano.Fluid.Ventilation.PartialPump;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
end three_zones_hydronic_reduced_orders_iso_13790_electric;