package house_multiple_construction_one_azimuth
...
,nPorts = 3,                    nConExt=3,
    ...
    Placement(transformation(origin = { 0.06942514267660727, -0.11945896648725807 },
    extent = {{ 5, -5}, {-5, 5}}
)));
    ...
    Placement(transformation(origin = { -14.930574857323393, -0.11945896648725807 },
    extent = {{ 3, -3}, {-3, 3}}
)));
     ...
     annotation (
    Placement(transformation(origin = { 35.01708691121786, -100.0 },
    extent = {{ 5, -5}, {-5, 5}}
)));
equation        
        connect(schema_space_001.qGai_flow,occupancy_1.y)
        annotation (Line(
        points={{ 0.06942514267660727, -0.11945896648725807 }    ,{ -7.430574857323393, -0.11945896648725807 }    ,{ -7.430574857323393, -0.11945896648725807 }    ,{ -14.930574857323393, -0.11945896648725807 }    },
        color={255,204,51},
        ...
        annotation (Line(
        points={{ 0.06942514267660727, -0.11945896648725807 }    ,{ 17.543256026947233, -0.11945896648725807 }    ,{ 17.543256026947233, -100.0 }    ,{ 35.01708691121786, -100.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 35.01708691121786, -100.0 }    ,{ 35.01708691121786, -100.0 }    ,{ 35.01708691121786, -100.0 }    ,{ 35.01708691121786, -100.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        house_multiple_construction_one_azimuth.Components.BaseClasses.DataServer
...
extends house_multiple_construction_one_azimuth.Trano.Occupancy.SimpleOccupancy ;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
...
end house_multiple_construction_one_azimuth;