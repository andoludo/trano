...
annotation (Line(points={{10,0},{110,0}}, color={0,0,127}));  connect(u, conVal.u_m) annotation (Line(points={{-118,0},{-22,0},{-22,-20},{0,
    ...
    extends buildings_simple_hydronic.Common.Controls.ventilation.PartialBoilerControl;
...
Rectangle(
  fillColor={255,255,255},
    ...
    extends buildings_simple_hydronic.Common.Fluid.Boilers.PartialBoilerWithStorage;
    Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
graphics={
    ...
    Line(points={{-100,80},{-38,80},{-38,38},{-10,38}}, color={255,255,0},
      thickness=1)}));
        ...
        model PumpPump
extends buildings_simple_hydronic.Common.Fluid.Ventilation.PartialPump;
Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
,
    ...
    Placement(transformation(origin = { -42.946578179314315, 190.00086863220494 },
    extent = {{-10, -10}, {10, 10}}
)));
...
,
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        buildings_simple_hydronic.Common.Controls.ventilation.
...
,
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        buildings_simple_hydronic.Common.Controls.ventilation.CollectorControlPump_control
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        data_bus (redeclare package
          Medium = Medium) annotation (
    Placement(transformation(origin = { 76.87405297629921, 179.9730672926596 },
    extent = {{-10, -10}, {10, 10}}
)));
...
annotation (Line(
points={{ 0.0, 0.0 }    ,{ 38.437026488149606, 0.0 }    ,{ 38.437026488149606, 179.9730672926596 }    ,{ 76.87405297629921, 179.9730672926596 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 0.0, -75.0 }    ,{ -21.473289089657158, -75.0 }    ,{ -21.473289089657158, 190.00086863220494 }    ,{ -42.946578179314315, 190.00086863220494 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ -42.946578179314315, 190.00086863220494 }    ,{ 16.963737398492448, 190.00086863220494 }    ,{ 16.963737398492448, 179.9730672926596 }    ,{ 76.87405297629921, 179.9730672926596 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ -250.0, -275.0 }    ,{ -86.5629735118504, -275.0 }    ,{ -86.56297351185039, 179.9730672926596 }    ,{ 76.87405297629921, 179.9730672926596 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 180.0, -275.0 }    ,{ 128.4370264881496, -275.0 }    ,{ 128.4370264881496, 179.9730672926596 }    ,{ 76.87405297629921, 179.9730672926596 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ -350.0, -375.0 }    ,{ -136.5629735118504, -375.0 }    ,{ -136.56297351185037, 179.9730672926596 }    ,{ 76.87405297629921, 179.9730672926596 }    },
color={255,204,51},
thickness=0.5,
