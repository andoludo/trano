model buildings_simple_hydronic
...
Buildings.ThermalZones.Detailed.MixedAir space_1(
    ...
    annotation (
    Placement(transformation(origin = { -87.03806236074045, 157.71807466465827 }, extent = {{-10, -10}, {10, 10}}
)));Modelica.Blocks.Sources.Constant three_way_valve_control(k= 1)
    annotation (
    Placement(transformation(origin = { -159.14107338207342, -56.4787342030502 }, extent = {{-10, -10}, {10, 10}}
...
annotation (Line(
points={{ -100.0, -125.0 }    ,{ -129.5705366910367, -125.0 }    ,{ -129.5705366910367, -56.4787342030502 }    ,{ -159.14107338207342, -56.4787342030502 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ -200.0, -225.0 }    ,{ -143.51903118037023, -225.0 }    ,{ -143.51903118037023, 157.71807466465827 }    ,{ -87.03806236074045, 157.71807466465827 }    },
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));
