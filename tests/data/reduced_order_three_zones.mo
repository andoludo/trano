package reduced_order_three_zones
...
Modelica.Fluid.Interfaces.FluidPorts_a[0] ports_a(
  ...
  annotation ( Placement(transformation(extent= {{-104,-80},{-94,-34}} ), iconTransformation(
    ...
    AixLib.ThermalZones.ReducedOrder.ThermalZone.ThermalZone space_1(
...
,
    ...
    ATransparent={ 0.0, 0.0, 10.0, 10.0 },
    RWin=0.001,
    hConWin=2.7,
    gWin=1,
    UWin=2.1,
    ...
    hConExt=2.7,
    nExt=1,
    RExt={ 0.8214285714285715 },
    RExtRem=0.8214285714285715,
    CExt={ 17704800.0 },
    ...
    hConFloor=2.7,
    nFloor=1,
    RFloor={ 0.8214285714285715 },
    RFloorRem=0.8214285714285715,
    CFloor={ 4426200.0 },
    ...
    aziExtWalls={ 2.356194490192345, 0.0, 0.7853981633974483, 1.5707963267948966 },
...
TThresholdCooler=273.15 + 22,
 ...
 annotation (
    ...
    Modelica.Blocks.Sources.CombiTimeTable occupancy_0(
...
,
    ...
    aziExtWalls={ 2.356194490192345, 0.0, 1.5707963267948966 },
    wfWall={ 0.2, 0.2, 0.2 },
...
,
    ...
    hRadRoof=5,
    tiltExtWalls={ 1.5707963267948966, 1.5707963267948966, 1.5707963267948966 },
    aziExtWalls={ 2.356194490192345, 0.0, 0.7853981633974483 },
    wfWall={ 0.2, 0.2, 0.2 },
    wfWin={ 0.25, 0.25, 0.25 },
    wfGro=0.1,
    specificPeople=1/14,
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        reduced_order_three_zones.Components.BaseClasses.DataServerReducedOrder
