package buildings_two_rooms_with_storage
...
annotation (Line(points={{10,0},{110,0}}, color={0,0,127}));  connect(u, conVal.u_m) annotation (Line(points={{-118,0},{-22,0},{-22,-20},{0,
    ...
    extends buildings_two_rooms_with_storage.Common.Controls.ventilation.PartialBoilerControl;
...
Rectangle(
  fillColor={255,255,255},
    ...
    extends buildings_two_rooms_with_storage.Common.Fluid.Boilers.PartialBoilerWithStorage;
    Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
graphics={
    ...
    Line(points={{-100,80},{-38,80},{-38,38},{-10,38}}, color={255,255,0},
      thickness=1)}));
        ...
        model PumpPump
extends buildings_two_rooms_with_storage.Common.Fluid.Ventilation.PartialPump;
Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
,
    ...
    Placement(transformation(origin = { 144.9828623006851, 139.60959359232743 },
    extent = {{-10, -10}, {10, 10}}
)));
        buildings_two_rooms_with_storage.Common.Occupancy.SimpleOccupancy occupancy_0 annotation (
...
,
    ...
    Placement(transformation(origin = { 117.36707548637253, -175.91375412258097 },
    extent = {{-10, -10}, {10, 10}}
)));
        buildings_two_rooms_with_storage.Common.Occupancy.SimpleOccupancy occupancy_1 annotation (
...
,
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        buildings_two_rooms_with_storage.Common.Controls.ventilation.CollectorControlPump_control
...
,
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        buildings_two_rooms_with_storage.Common.Controls.ventilation.
...
redeclare package MediumW = MediumW) "Boiler"  annotation (
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        data_bus (redeclare package
          Medium = Medium) annotation (
    Placement(transformation(origin = { 112.53261639502222, 159.825089122873 },
    extent = {{-10, -10}, {10, 10}}
)));
...
annotation (Line(
points={{ 0.0, 0.0 }    ,{ 56.26630819751111, 0.0 }    ,{ 56.26630819751111, 159.825089122873 }    ,{ 112.53261639502222, 159.825089122873 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 0.0, -75.0 }    ,{ 72.49143115034255, -75.0 }    ,{ 72.49143115034255, 139.60959359232743 }    ,{ 144.9828623006851, 139.60959359232743 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 144.9828623006851, 139.60959359232743 }    ,{ 128.75773934785366, 139.60959359232743 }    ,{ 128.75773934785366, 159.825089122873 }    ,{ 112.53261639502222, 159.825089122873 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 250.0, 150.0 }    ,{ 181.2663081975111, 150.0 }    ,{ 181.2663081975111, 159.825089122873 }    ,{ 112.53261639502222, 159.825089122873 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 250.0, 75.0 }    ,{ 183.68353774318626, 75.0 }    ,{ 183.68353774318626, -175.91375412258097 }    ,{ 117.36707548637253, -175.91375412258097 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 117.36707548637253, -175.91375412258097 }    ,{ 114.94984594069737, -175.91375412258097 }    ,{ 114.94984594069737, 159.825089122873 }    ,{ 112.53261639502222, 159.825089122873 }    },
color={255,204,51},
thickness=0.5,
...
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(pump.port_b,temperature_sensor.port_a)
annotation (Line(
...
annotation (Line(
points={{ -250.0, -275.0 }    ,{ -68.73369180248889, -275.0 }    ,{ -68.73369180248889, 159.825089122873 }    ,{ 112.53261639502222, 159.825089122873 }    },
color={255,204,51},
thickness=0.5,
...
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(three_way_valve.port_2,pump.port_a)
annotation (Line(
...
annotation (Line(
points={{ -350.0, -375.0 }    ,{ -118.73369180248889, -375.0 }    ,{ -118.73369180248889, 159.825089122873 }    ,{ 112.53261639502222, 159.825089122873 }    },
color={255,204,51},
thickness=0.5,
...
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(boiler.port_b,three_way_valve.port_1)
annotation (Line(
...
annotation (Line(
points={{ -450.0, -475.0 }    ,{ -168.73369180248892, -475.0 }    ,{ -168.73369180248886, 159.825089122873 }    ,{ 112.53261639502222, 159.825089122873 }    },
color={255,204,51},
thickness=0.5,
