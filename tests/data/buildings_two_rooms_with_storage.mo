...
,
    ...
    Placement(transformation(origin = { 108.81168882624827, 170.0830261454242 },
    extent = {{-10, -10}, {10, 10}}
)));
...
,
    ...
    Placement(transformation(origin = { -180.345093479796, 33.17878708163723 },
    extent = {{-10, -10}, {10, 10}}
)));
...
,
    ...
    extent = {{-10, -10}, {10, 10}}
      ...
      buildings_two_rooms_with_storage.Common.Fluid.Ventilation.PumpPump
     pump(
...
,
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        buildings_two_rooms_with_storage.Common.Controls.ventilation.ThreeWayValveControlThree_way_valve_control
    three_way_valve_control annotation (
    Placement(transformation(origin = { -350, -325 },
    extent = {{-10, -10}, {10, 10}}
)));
        buildings_two_rooms_with_storage.Common.Fluid.Boilers.BoilerWithStorageBoiler boiler(
        a={0.9},
...
,
    ...
    Placement(transformation(origin = { -400, -425 },
    extent = {{-10, -10}, {10, 10}}
)));
    ...
    Placement(transformation(origin = { -450, -425 },
    extent = {{-10, -10}, {10, 10}}
)));
        buildings_two_rooms_with_storage.Common.Controls.ventilation.DataServer
        data_bus (redeclare package
          Medium = Medium) annotation (
    Placement(transformation(origin = { -193.89183421034662, 67.45708338817464 },
    extent = {{-10, -10}, {10, 10}}
)));
...
annotation (Line(
points={{ 0.0, 50.0 }    ,{ -96.94591710517331, 50.0 }    ,{ -96.94591710517331, 67.45708338817464 }    ,{ -193.89183421034662, 67.45708338817464 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 0.0, -25.0 }    ,{ 54.405844413124136, -25.0 }    ,{ 54.405844413124136, 170.0830261454242 }    ,{ 108.81168882624827, 170.0830261454242 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 108.81168882624827, 170.0830261454242 }    ,{ -42.54007269204918, 170.0830261454242 }    ,{ -42.540072692049165, 67.45708338817464 }    ,{ -193.89183421034662, 67.45708338817464 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 200.0, 50.0 }    ,{ 3.0540828948267063, 50.0 }    ,{ 3.054082894826678, 67.45708338817464 }    ,{ -193.89183421034662, 67.45708338817464 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 200.0, -25.0 }    ,{ 9.827453260102004, -25.0 }    ,{ 9.827453260102004, 33.17878708163723 }    ,{ -180.345093479796, 33.17878708163723 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ -180.345093479796, 33.17878708163723 }    ,{ -187.1184638450713, 33.17878708163723 }    ,{ -187.1184638450713, 67.45708338817464 }    ,{ -193.89183421034662, 67.45708338817464 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ 130.0, -125.0 }    ,{ -135.0, -125.0 }    ,{ -135.0, -425.0 }    ,{ -400.0, -425.0 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ -250.0, -225.0 }    ,{ -221.9459171051733, -225.0 }    ,{ -221.9459171051733, 67.45708338817464 }    ,{ -193.89183421034662, 67.45708338817464 }    },
color={255,204,51},
thickness=0.5,
...
annotation (Line(
points={{ -300.0, -325.0 }    ,{ -85.0, -325.0 }    ,{ -85.0, -125.0 }    ,{ 130.0, -125.0 }    },
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(three_way_valve_control.u,temperature_sensor.T)
annotation (Line(
points={{ -350.0, -325.0 }    ,{ -225.0, -325.0 }    ,{ -225.0, -125.0 }    ,{ -100.0, -125.0 }    },
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(three_way_valve_control.dataBus,data_bus.dataBus)
annotation (Line(
points={{ -350.0, -325.0 }    ,{ -271.9459171051733, -325.0 }    ,{ -271.9459171051733, 67.45708338817464 }    ,{ -193.89183421034662, 67.45708338817464 }    },
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(boiler.dataBus,boiler_control.dataBus)
annotation (Line(
points={{ -400.0, -425.0 }    ,{ -425.0, -425.0 }    ,{ -425.0, -425.0 }    ,{ -450.0, -425.0 }    },
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(boiler.port_b,three_way_valve.port_1)
annotation (Line(
points={{ -400.0, -425.0 }    ,{ -350.0, -425.0 }    ,{ -350.0, -325.0 }    ,{ -300.0, -325.0 }    },
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(boiler_control.dataBus,data_bus.dataBus)
annotation (Line(
points={{ -450.0, -425.0 }    ,{ -321.9459171051733, -425.0 }    ,{ -321.9459171051733, 67.45708338817464 }    ,{ -193.89183421034662, 67.45708338817464 }    },
color={255,204,51},
thickness=0.5,
