package single_zone_hydronic_emission_from_data
...
,nPorts = 3,                    nConExt=1,
    ...
    Placement(transformation(origin = { 0.06942047998150258, -0.11832652486266682 },
    extent = {{ 5, -5}, {-5, 5}}
)));
    ...
    Placement(transformation(origin = { -14.930579520018497, -0.11832652486266682 },
    extent = {{ 3, -3}, {-3, 3}}
)));
     ...
     annotation (
    Placement(transformation(origin = { 35.01598550897833, -100.0 },
    extent = {{ 5, -5}, {-5, 5}}
)));
equation        
        connect(space_001.heaPorRad,heatPortRad[1])
        annotation (Line(
        points={{ 0.06942047998150258, -0.11832652486266682 }    ,{ 0.03471023999075129, -0.11832652486266682 }    ,{ 0.03471023999075129, 0.0 }    ,{ 0.0, 0.0 }    },
        color={0, 0, 139},
        thickness=0.1,pattern =
        LinePattern.Dash,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 0.06942047998150258, -0.11832652486266682 }    ,{ -7.430579520018497, -0.11832652486266682 }    ,{ -7.430579520018497, -0.11832652486266682 }    ,{ -14.930579520018497, -0.11832652486266682 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 0.06942047998150258, -0.11832652486266682 }    ,{ 17.542702994479917, -0.11832652486266682 }    ,{ 17.542702994479917, -100.0 }    ,{ 35.01598550897833, -100.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 35.01598550897833, -100.0 }    ,{ 35.01598550897833, -100.0 }    ,{ 35.01598550897833, -100.0 }    ,{ 35.01598550897833, -100.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        single_zone_hydronic_emission_from_data.Components.BaseClasses.DataServer
...
coordinateSystem(preserveAspectRatio=false)));
  ...
  package BaseClasses
        model EmissionControlMonitoredSetpointEmission_control_001
...
connect(dataBus.OccupiedSpace_001, occSch2.occupied);
    ...
    extends single_zone_hydronic_emission_from_data.Trano.Controls.ventilation.PartialBoilerControl;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
connect(sum1.y, loa.Pow) annotation (Line(points={{-51,-26},{-38,-26},{-38,-76},
    ...
    extends single_zone_hydronic_emission_from_data.Trano.Fluid.Boilers.PartialBoilerWithStorage;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
connect(dataBus.TStoBotBoiler_001, tanTemBot.T);
        ...
        model PumpPump_001
extends single_zone_hydronic_emission_from_data.Trano.Fluid.Ventilation.PartialPump;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
end single_zone_hydronic_emission_from_data;