...
Modelica.Fluid.Interfaces.FluidPorts_a[0] ports_a(
  ...
  annotation ( Placement(transformation(extent= {{-104,-80},{-94,-34}} ), iconTransformation(
    ...
    AixLib.ThermalZones.ISO13790.Zone5R1C.ZoneHVAC space_1(
redeclare package Medium = Medium,
    AFlo=20.0,
    VRoo=40.0
,
...
nOrientations=4,
surAzi={ 2.356194490192345, 0.0, 0.7853981633974483, 1.5707963267948966 },
surTil={ 1.5707963267948966, 1.5707963267948966, 1.5707963267948966, 1.5707963267948966 },
UWal = 0.608695652173913,

AWin={ 0.0, 0.0, 10.0, 10.0 },
UWin=1.9455252918287942,
UFlo=0.608695652173913,
airRat=0.5,
ARoo=0.0,
URoo=0.001,
...
gFac=0.5) "Thermal zone"
 annotation (
    ...
    occupancy_0 annotation (
    Placement(transformation(origin = { 35.44934546770594, -59.364180780387386 },
    extent = {{10, -10}, {-10, 10}}
)));
    AixLib.ThermalZones.ISO13790.Zone5R1C.ZoneHVAC space_2(
redeclare package Medium = Medium,
    AFlo=20.0,
    VRoo=40.0
,
AWal={ 10.0, 10.0, 10.0 },
nOrientations=3,
surAzi={ 2.356194490192345, 0.0, 1.5707963267948966 },
...
gFac=0.5) "Thermal zone"
 annotation (
    ...
    AixLib.ThermalZones.ISO13790.Zone5R1C.ZoneHVAC space_3(
redeclare package Medium = Medium,
    AFlo=20.0,
    VRoo=40.0
,
AWal={ 10.0, 10.0, 10.0 },
nOrientations=3,
surAzi={ 2.356194490192345, 0.0, 0.7853981633974483 },
surTil={ 1.5707963267948966, 1.5707963267948966, 1.5707963267948966 },
UWal = 0.608695652173913,
...
equation        
        connect(space_1.intLatGai,occupancy_0.y)
        annotation (Line(
        ...
        smooth=Smooth.None))
            ;        
        connect(space_1.intSenGai,occupancy_0.y1)
        annotation (Line(
        points={{ 49.449186579219145, -26.836343220735486 }    ,{ 42.44926602346254, -26.836343220735486 }    ,{ 42.44926602346254, -59.364180780387386 }    ,{ 35.44934546770594, -59.364180780387386 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        ...
        smooth=Smooth.None))
            ;        
        connect(space_2.intLatGai,occupancy_1.y)
        annotation (Line(
        ...
        smooth=Smooth.None))
            ;        
        connect(space_2.intSenGai,occupancy_1.y1)
        annotation (Line(
        points={{ -53.37593898682108, -51.78253953401329 }    ,{ -76.68796949341055, -51.78253953401329 }    ,{ -76.68796949341055, -43.02891363338636 }    ,{ -100.0, -43.02891363338636 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        ...
        smooth=Smooth.None))
            ;        
        connect(space_3.intLatGai,occupancy_2.y)
        annotation (Line(
        ...
        smooth=Smooth.None))
            ;        
        connect(space_3.intSenGai,occupancy_2.y1)
        annotation (Line(
        points={{ -24.25300343375673, 47.5133339571442 }    ,{ -13.729951362468768, 47.5133339571442 }    ,{ -13.729951362468768, 89.70244221951904 }    ,{ -3.206899291180804, 89.70244221951904 }    },
        color={255,204,51},
        thickness=0.1,pattern =
