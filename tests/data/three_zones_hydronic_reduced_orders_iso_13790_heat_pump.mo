package three_zones_hydronic_reduced_orders_iso_13790_heat_pump
...
Trano.Controls.BaseClasses.DataBus dataBus 
    annotation (
      ...
      three_zones_hydronic_reduced_orders_iso_13790_heat_pump.Components.BaseClasses.PumpPump_001
     pump_001(
         dp_nominal=10000.0,
...
gFac=0.5) "Thermal zone"
 annotation (
    Placement(transformation(origin = { 56.35457160338814, -46.14491668226924 },
    extent = {{10, -10}, {-10, 10}}
)));
    ...
    Placement(transformation(origin = { 96.71028609876095, -30.632840292080132 },
    extent = {{10, -10}, {-10, 10}}
)));
...
gFac=0.5) "Thermal zone"
 annotation (
    Placement(transformation(origin = { 6.9053505353229525, 41.16832053922485 },
    extent = {{10, -10}, {-10, 10}}
)));
    ...
    Placement(transformation(origin = { 38.643999781631095, 81.00355738625723 },
    extent = {{10, -10}, {-10, 10}}
)));
...
gFac=0.5) "Thermal zone"
 annotation (
    Placement(transformation(origin = { -57.55035424688594, -45.58696873244711 },
    extent = {{10, -10}, {-10, 10}}
)));
    ...
    Placement(transformation(origin = { -42.59633579754647, -84.5703051862947 },
    extent = {{10, -10}, {-10, 10}}
)));
...
weather (
 ...
 annotation (
    Placement(transformation(origin = { -0.5163574642828479, -25.034637708294326 },
    extent = {{10, -10}, {-10, 10}}
)));
...
equation        
        ...
        annotation (Line(
        points={{ 56.35457160338814, -46.14491668226924 }    ,{ 28.17728580169407, -46.14491668226924 }    ,{ 28.17728580169407, 0.0 }    ,{ 0.0, 0.0 }    },
        color={0, 0, 139},
        thickness=0.1,pattern =
        LinePattern.Dash,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 56.35457160338814, -46.14491668226924 }    ,{ 76.53242885107454, -46.14491668226924 }    ,{ 76.53242885107454, -30.632840292080132 }    ,{ 96.71028609876095, -30.632840292080132 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 56.35457160338814, -46.14491668226924 }    ,{ 27.919107069552645, -46.14491668226924 }    ,{ 27.919107069552645, -25.034637708294326 }    ,{ -0.5163574642828479, -25.034637708294326 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 6.9053505353229525, 41.16832053922485 }    ,{ 3.4526752676614763, 41.16832053922485 }    ,{ 3.4526752676614763, 0.0 }    ,{ 0.0, 0.0 }    },
        color={0, 0, 139},
        thickness=0.1,pattern =
        LinePattern.Dash,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 6.9053505353229525, 41.16832053922485 }    ,{ 22.774675158477024, 41.16832053922485 }    ,{ 22.774675158477024, 81.00355738625723 }    ,{ 38.643999781631095, 81.00355738625723 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 6.9053505353229525, 41.16832053922485 }    ,{ 3.1944965355200523, 41.16832053922485 }    ,{ 3.1944965355200523, -25.034637708294326 }    ,{ -0.5163574642828479, -25.034637708294326 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ -57.55035424688594, -45.58696873244711 }    ,{ -28.77517712344297, -45.58696873244711 }    ,{ -28.77517712344297, 0.0 }    ,{ 0.0, 0.0 }    },
        color={0, 0, 139},
        thickness=0.1,pattern =
        LinePattern.Dash,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ -57.55035424688594, -45.58696873244711 }    ,{ -50.0733450222162, -45.58696873244711 }    ,{ -50.0733450222162, -84.5703051862947 }    ,{ -42.59633579754647, -84.5703051862947 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ -57.55035424688594, -45.58696873244711 }    ,{ -29.033355855584393, -45.58696873244711 }    ,{ -29.033355855584393, -25.034637708294326 }    ,{ -0.5163574642828479, -25.034637708294326 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ -0.5163574642828479, -25.034637708294326 }    ,{ -0.5163574642828479, -25.034637708294326 }    ,{ -0.5163574642828479, -25.034637708294326 }    ,{ -0.5163574642828479, -25.034637708294326 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        three_zones_hydronic_reduced_orders_iso_13790_heat_pump.Components.BaseClasses.DataServerReducedOrder
...
connect(dataBus.yHeaValve_002, emissionControl.yHea);
        ...
        model CollectorControlControl_4
...
end CollectorControlControl_4;
        model ThreeWayValveControlControl_5
  Buildings.Controls.OBC.CDL.Reals.PIDWithReset
                                      conVal(
...
annotation (Placement(transformation(extent={{-138,-20},{-98,20}})));        Trano.Controls.BaseClasses.DataBus dataBus
  ...
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
connect(dataBus.TColSetControl_5, conVal.u_s);
connect(dataBus.triggerControl_5, conVal.trigger);
  connect(conVal.y, y)
annotation (Line(points={{10,0},{110,0}}, color={0,0,127}));  connect(u, conVal.u_m) annotation (Line(points={{-118,0},{-22,0},{-22,-20},{0,
        ...
        coordinateSystem(preserveAspectRatio=false)));end ThreeWayValveControlControl_5;
...
connect(sum1.y, loa.Pow) annotation (Line(points={{-51,-26},{-38,-26},{-38,-76},
    {24,-76},{24,-49},{16,-49}}, color={0,0,127}));
            ...
            model HeatPumpBoiler_001
    extends three_zones_hydronic_reduced_orders_iso_13790_heat_pump.Trano.Fluid.Boilers.PartialHeatPump;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
    
     end HeatPumpBoiler_001;
     
        model PumpPump_001
extends three_zones_hydronic_reduced_orders_iso_13790_heat_pump.Trano.Fluid.Ventilation.PartialPump;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
connect(dataBus.TControl_4, temSup.T);
 end PumpPump_001;
...
end three_zones_hydronic_reduced_orders_iso_13790_heat_pump;