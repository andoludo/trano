package single_zone_air_handling_unit_complex_vav
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        single_zone_air_handling_unit_complex_vav.Components.BaseClasses.DataServer
...
extends single_zone_air_handling_unit_complex_vav.Trano.Occupancy.SimpleOccupancy ;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
...
connect(sum1.y, loa.Pow) annotation (Line(points={{-51,-26},{-38,-26},{-38,-76},
    {24,-76},{24,-49},{16,-49}}, color={0,0,127}));
        ...
        model VAVBoxVav_001
extends single_zone_air_handling_unit_complex_vav.Trano.Fluid.Ventilation.PartialVAVBox;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
equation
...
connect(dataBus.TDisVav_control_001, senTem.T);
            ...
            model AhuAhu_001
    extends single_zone_air_handling_unit_complex_vav.Trano.Fluid.Ventilation.PartialAhu;
    Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
  extent={{-120,-18},{-80,22}}), iconTransformation(extent={{-120,62},{-78,98}})));
    equation
...
,nPorts = 3,                    nConExt=1,
    ...
    Placement(transformation(origin = { 374.91953637346046, 157.41962077493818 },
    extent = {{10, -10}, {-10, 10}}
)));
        single_zone_air_handling_unit_complex_vav.Components.BaseClasses.VAVControlVav_control_001
    vav_control_001 annotation (
    Placement(transformation(origin = { 215.92341033133462, 0.0 },
    extent = {{10, -10}, {-10, 10}}
)));
      Buildings.Fluid.FixedResistances.PressureDrop
    duct_002(
    ...
    allowFlowReversal = false,
    dp_nominal=40) "Pressure drop for return duct"  annotation (
    Placement(transformation(origin = { 472.31466057028723, 868.3841714756801 },
    extent = {{10, -10}, {-10, 10}}
)));
      Buildings.Fluid.FixedResistances.PressureDrop
    duct_001(
    ...
    allowFlowReversal = false,
    dp_nominal=40) "Pressure drop for return duct"  annotation (
    Placement(transformation(origin = { 99.27553476613856, 288.1560868370431 },
    extent = {{10, -10}, {-10, 10}}
)));
        Buildings.BoundaryConditions.WeatherData.ReaderTMY3
                weather(filNam=Modelica.Utilities.Files.loadResource
    ...
    AFlo={20,20},
    mCooVAV_flow_nominal={0.01,0.01}) annotation (
    Placement(transformation(origin = { 174.35541320266694, 687.4553448749657 },
    extent = {{10, -10}, {-10, 10}}
)));
        single_zone_air_handling_unit_complex_vav.Components.BaseClasses.AhuControlAhu_control_001
    ahu_control_001 annotation (
    Placement(transformation(origin = { 0.0, 567.1887881286068 },
    extent = {{10, -10}, {-10, 10}}
)));
      Buildings.Fluid.Sources.Boundary_pT boundary
    (nPorts=2,redeclare package Medium = Medium) annotation (
    Placement(transformation(origin = { 183.99154205370485, 1000.0 },
    extent = {{10, -10}, {-10, 10}}
)));
        single_zone_air_handling_unit_complex_vav.Components.BaseClasses.DataServer
        data_bus (redeclare package
          Medium = Medium) annotation (
    Placement(transformation(origin = { 311.6312366625444, 430.0769442154438 },
    extent = {{10, -10}, {-10, 10}}
)));
...
equation            
        ...
        annotation (Line(
        points={{ 0.0, 0.0 }    ,{ 236.15733028514362, 0.0 }    ,{ 236.15733028514362, 868.3841714756801 }    ,{ 472.31466057028723, 868.3841714756801 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        connect(vav_001.dataBus,vav_control_001.dataBus)
        annotation (Line(
        points={{ 374.91953637346046, 157.41962077493818 }    ,{ 295.4214733523975, 157.41962077493818 }    ,{ 295.4214733523975, 0.0 }    ,{ 215.92341033133462, 0.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 374.91953637346046, 157.41962077493818 }    ,{ 187.45976818673023, 157.41962077493818 }    ,{ 187.45976818673023, 0.0 }    ,{ 0.0, 0.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        connect(duct_002.port_b,ahu_001.port_a)
        annotation (Line(
        points={{ 472.31466057028723, 868.3841714756801 }    ,{ 323.3350368864771, 868.3841714756801 }    ,{ 323.33503688647704, 687.4553448749657 }    ,{ 174.35541320266694, 687.4553448749657 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        connect(duct_001.port_b,vav_001.port_aAir)
        annotation (Line(
        points={{ 99.27553476613856, 288.1560868370431 }    ,{ 237.0975355697995, 288.1560868370431 }    ,{ 237.0975355697995, 157.41962077493818 }    ,{ 374.91953637346046, 157.41962077493818 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        connect(ahu_001.dataBus,ahu_control_001.dataBus)
        annotation (Line(
        points={{ 174.35541320266694, 687.4553448749657 }    ,{ 87.17770660133347, 687.4553448749657 }    ,{ 87.17770660133347, 567.1887881286068 }    ,{ 0.0, 567.1887881286068 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        connect(ahu_001.port_b,duct_001.port_a)
        annotation (Line(
        points={{ 174.35541320266694, 687.4553448749657 }    ,{ 136.81547398440276, 687.4553448749657 }    ,{ 136.81547398440276, 288.1560868370431 }    ,{ 99.27553476613856, 288.1560868370431 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        connect(boundary.ports,ahu_001.ports)
        annotation (Line(
        points={{ 183.99154205370485, 1000.0 }    ,{ 179.17347762818588, 1000.0 }    ,{ 179.17347762818588, 687.4553448749657 }    ,{ 174.35541320266694, 687.4553448749657 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ -50.0, 0.0 }    ,{ 130.8156183312722, 0.0 }    ,{ 130.8156183312722, 430.0769442154438 }    ,{ 311.6312366625444, 430.0769442154438 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 215.92341033133462, 0.0 }    ,{ 263.7773234969395, 0.0 }    ,{ 263.7773234969395, 430.0769442154438 }    ,{ 311.6312366625444, 430.0769442154438 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 0.0, 567.1887881286068 }    ,{ 155.8156183312722, 567.1887881286068 }    ,{ 155.8156183312722, 430.0769442154438 }    ,{ 311.6312366625444, 430.0769442154438 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 0.0, 0.0 }    ,{ 155.8156183312722, 0.0 }    ,{ 155.8156183312722, 430.0769442154438 }    ,{ 311.6312366625444, 430.0769442154438 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
...
end single_zone_air_handling_unit_complex_vav;