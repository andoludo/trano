...
,nPorts = 3,                    nConExt=0,                    nSurBou=0,                    nConBou=0,                    nConExtWin=1,
    ...
    Placement(transformation(origin = { 0.19238179632354502, -0.09845084696685547 },
    extent = {{10, -10}, {-10, 10}}
)));
    ...
    Placement(transformation(origin = { 100.0, -2.209352830461853 },
    extent = {{10, -10}, {-10, 10}}
)));
     ...
     annotation (
    Placement(transformation(origin = { 3.6705523074991504, 100.0 },
    extent = {{10, -10}, {-10, 10}}
)));
equation        
        connect(door.qGai_flow,occupancy_0.y)
        annotation (Line(
        points={{ 0.19238179632354502, -0.09845084696685547 }    ,{ 50.09619089816177, -0.09845084696685547 }    ,{ 50.09619089816177, -2.209352830461853 }    ,{ 100.0, -2.209352830461853 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
            ;        
        connect(door.weaBus,weather_16.weaBus)
        annotation (Line(
        points={{ 0.19238179632354502, -0.09845084696685547 }    ,{ 1.9314670519113477, -0.09845084696685547 }    ,{ 1.9314670519113477, 100.0 }    ,{ 3.6705523074991504, 100.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        connect(occupancy_0.dataBus,dataBus)
            ;        
        connect(door.heaPorAir,heatPortCon1[1])
            ;        
        connect(door.ports[1],ports_b[1])
            ;        
        connect(weather_16.weaBus,dataBus)
        annotation (Line(
        points={{ 3.6705523074991504, 100.0 }    ,{ 3.6705523074991504, 100.0 }    ,{ 3.6705523074991504, 100.0 }    ,{ 3.6705523074991504, 100.0 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
...
Trano.Controls.BaseClasses.DataBus dataBus 
  ...
  Placement(transformation(extent= {{66,-24},{114,24}} ), iconTransformation(
      extent= {{66,-24},{114,24}} )));
        space_with_door.Components.BaseClasses.DataServer
...
extends space_with_door.Trano.Occupancy.SimpleOccupancy ;
Trano.Controls.BaseClasses.DataBus dataBus
    annotation (Placement(transformation(
...
,nPorts = 3,                    nConExt=0,                    nSurBou=0,                    nConBou=0,                    nConExtWin=1,
    ...
    extent = {{10, -10}, {-10, 10}}
        ...
        data_bus (redeclare package
          Medium = Medium) annotation (
    Placement(transformation(origin = { 1000.0, 504.0032195204609 },
    extent = {{10, -10}, {-10, 10}}
)));
...
equation            
        ...
        annotation (Line(
        points={{ -50.0, 0.0 }    ,{ 475.0, 0.0 }    ,{ 475.0, 504.0032195204609 }    ,{ 1000.0, 504.0032195204609 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
            ;            
        connect(door.heaPorAir,data_bus.port[1])
        annotation (Line(
        points={{ 0.0, 0.0 }    ,{ 500.0, 0.0 }    ,{ 500.0, 504.0032195204609 }    ,{ 1000.0, 504.0032195204609 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
            ;            
        connect(door.ports[1],data_bus.port_a[1])
        annotation (Line(
        points={{ 0.0, 0.0 }    ,{ 500.0, 0.0 }    ,{ 500.0, 504.0032195204609 }    ,{ 1000.0, 504.0032195204609 }    },
        color={255,204,51},
        thickness=0.1,pattern =
