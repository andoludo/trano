...
,nPorts = 3,                    nConExt=0,                    nSurBou=0,                    nConBou=0,                    nConExtWin=1,
    ...
    Placement(transformation(origin = { 1000.0, 676.4920472785642 },
    extent = {{10, -10}, {-10, 10}}
)));
...
equation            
        ...
        annotation (Line(
        points={{ -50.0, 0.0 }    ,{ 475.0, 0.0 }    ,{ 475.0, 676.4920472785642 }    ,{ 1000.0, 676.4920472785642 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
        ...
        annotation (Line(
        points={{ 0.0, 0.0 }    ,{ 500.0, 0.0 }    ,{ 500.0, 676.4920472785642 }    ,{ 1000.0, 676.4920472785642 }    },
        color={255,204,51},
        thickness=0.1,pattern =
        LinePattern.Solid,
        smooth=Smooth.None))
