...
,nPorts = 3,                    nConExt=2,
    ...
    extent = {{-20, -20}, {20, 20}}
        ...
        buildings_free_float_three_zones.Common.Controls.ventilation.OccupancyOccupancy_0 occupancy_0(    occupancy=3600*{7, 19},
    gain=[35; 70; 30],
    k=1/6/4
) annotation (
...
,nPorts = 3,                    nConExt=1,
    ...
    extent = {{-20, -20}, {20, 20}}
        ...
        buildings_free_float_three_zones.Common.Controls.ventilation.OccupancyOccupancy_1 occupancy_1(    occupancy=3600*{7, 19},
    gain=[35; 70; 30],
    k=1/6/4
) annotation (
...
,nPorts = 3,                    nConExt=2,
    ...
    extent = {{-20, -20}, {20, 20}}
        ...
        buildings_free_float_three_zones.Common.Controls.ventilation.OccupancyOccupancy_2 occupancy_2(    occupancy=3600*{7, 19},
    gain=[35; 70; 30],
    k=1/6/4
) annotation (
    ...
    Buildings.BoundaryConditions.WeatherData.ReaderTMY3
                weather_2(filNam=Modelica.Utilities.Files.loadResource
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        data_bus (redeclare package
          Medium = Medium) annotation (
    Placement(transformation(origin = { -200.00000000000003, -27.488252580986792 },
    extent = {{-10, -10}, {10, 10}}
)));
...
color={191,0,0},
thickness=0.1,
smooth=Smooth.None));    connect(space_1.weaBus,weather_2.weaBus)
annotation (Line(
...
color={191,0,0},
thickness=0.1,
smooth=Smooth.None));    connect(space_2.weaBus,weather_2.weaBus)
annotation (Line(
...
color={191,0,0},
thickness=0.1,
smooth=Smooth.None));    connect(space_3.weaBus,weather_2.weaBus)
annotation (Line(
points={{ 500.0, 150.0 }    ,{ 200.0, 150.0 }    ,{ 200.0, 200.0 }    ,{ -100.0, 200.0 }    },
thickness=0.05,
smooth=Smooth.None));    connect(occupancy_0.dataBus,data_bus.dataBus)
annotation (Line(
points={{ -50.0, 0.0 }    ,{ -125.00000000000001, 0.0 }    ,{ -125.00000000000001, -27.488252580986792 }    ,{ -200.00000000000003, -27.488252580986792 }    },
thickness=0.05,
smooth=Smooth.None));    connect(occupancy_1.dataBus,data_bus.dataBus)
annotation (Line(
points={{ 200.0, 150.0 }    ,{ 0.0, 150.0 }    ,{ -2.842170943040401e-14, -27.488252580986792 }    ,{ -200.00000000000003, -27.488252580986792 }    },
thickness=0.05,
smooth=Smooth.None));    connect(occupancy_2.dataBus,data_bus.dataBus)
annotation (Line(
points={{ 450.0, 150.0 }    ,{ 125.0, 150.0 }    ,{ 124.99999999999997, -27.488252580986792 }    ,{ -200.00000000000003, -27.488252580986792 }    },
thickness=0.05,
smooth=Smooth.None));    connect(space_1.heaPorAir,data_bus.port[1])
annotation (Line(
points={{ 0.0, 0.0 }    ,{ -100.00000000000001, 0.0 }    ,{ -100.00000000000001, -27.488252580986792 }    ,{ -200.00000000000003, -27.488252580986792 }    },
thickness=0.05,
...
annotation (Line(
points={{ 250.0, 150.0 }    ,{ 25.0, 150.0 }    ,{ 24.99999999999997, -27.488252580986792 }    ,{ -200.00000000000003, -27.488252580986792 }    },
thickness=0.05,
...
annotation (Line(
points={{ 500.0, 150.0 }    ,{ 150.0, 150.0 }    ,{ 149.99999999999997, -27.488252580986792 }    ,{ -200.00000000000003, -27.488252580986792 }    },
thickness=0.05,
smooth=Smooth.None));    connect(space_3.ports[1],data_bus.port_a[3])
annotation (Line(
points={{ 500.0, 150.0 }    ,{ 150.0, 150.0 }    ,{ 149.99999999999997, -27.488252580986792 }    ,{ -200.00000000000003, -27.488252580986792 }    },
thickness=0.05,
smooth=Smooth.None));annotation (Diagram(coordinateSystem(extent={{-250.00000000000003,-243.27144513452555},{550.0,250.0}})), Icon(
        coordinateSystem(extent={{-250.00000000000003,-243.27144513452555},{550.0,250.0}})));
  annotation (
