package space_with_same_properties
...
,nPorts = 3,                    nConExt=2,
    ...
    extent = {{-20, -20}, {20, 20}}
        ...
        space_with_same_properties.Common.Occupancy.SimpleOccupancy occupancy_0 annotation (
    ...
    extent = {{-10, -10}, {10, 10}}
        ...
        data_bus (redeclare package
          Medium = Medium) annotation (
    Placement(transformation(origin = { -32.91435499562398, 185.04088548493445 },
    extent = {{-10, -10}, {10, 10}}
)));


equation    connect(bed.qGai_flow,occupancy_0.y)
annotation (Line(
points={{ 0.0, 0.0 }    ,{ -25.0, 0.0 }    ,{ -25.0, 0.0 }    ,{ -50.0, 0.0 }    },
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));    connect(bed.weaBus,weather.weaBus)
annotation (Line(
...
annotation (Line(
points={{ 0.0, 0.0 }    ,{ -16.45717749781199, 0.0 }    ,{ -16.45717749781199, 185.04088548493445 }    ,{ -32.91435499562398, 185.04088548493445 }    },
color={255,204,51},
thickness=0.5,
...
color={255,204,51},
thickness=0.5,
smooth=Smooth.None));annotation (Diagram(coordinateSystem(extent={{-150.0,-202.15468378185776},{244.9866832293963,250.0}})), Icon(
        coordinateSystem(extent={{-150.0,-202.15468378185776},{244.9866832293963,250.0}})));
  annotation (
