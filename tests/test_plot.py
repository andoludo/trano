...
def test_plot_one_figure(buildings_two_rooms_with_storage: Network, data_reader: Reader) -> None:
...
def test_plot_one_figure_container(building_multiple_internal_walls: Network, data_reader_container: Reader) -> None:
    building_multiple_internal_walls.model()
    space = [s for s in building_multiple_internal_walls.graph.nodes if isinstance(s, Space)]
...
def test_plot_element(buildings_two_rooms_with_storage: Network, data_reader: Reader) -> None:
    space = [s for s in buildings_two_rooms_with_storage.graph.nodes if isinstance(s, Space)]
